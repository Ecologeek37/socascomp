 ...
 *	\ingroup    facture
 *	\brief      File of class to generate customers invoices from crevette model
 */
...
/**
 *	Class to generate the customer invoice PDF with template Crevette
 */
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if (!getDolGlobalInt('PDF_DISABLE_MYCOMPANY_LOGO')) {
			if ($this->emetteur->logo) {
				...
				/*if (!getDolGlobalInt('MAIN_PDF_USE_LARGE_LOGO')) { //TODO fix size
